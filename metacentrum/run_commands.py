...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="commands",
        type=str,
        help="File with commands to be run.",
    )
    parser.add_argument(
        "--script", default=None, type=str, help="File with a qsub script."
    )
    parser.add_argument("--ensemble", action="store_true", help="Create ensemble.")
    parser.add_argument(
        "--wandb_api_key",
        action="store_true",
        help="Read wandb_api_key.yaml file and set an ENV var with it.",
    )
    parser.add_argument(
        "--models", default=10, type=int, help="Number of models in an ensemble."
    )
    parser.add_argument(
        "--num_of_command_repetitions",
        default=1,
        type=int,
        help="Number of repetitions of each command in the command_file..",
    )
